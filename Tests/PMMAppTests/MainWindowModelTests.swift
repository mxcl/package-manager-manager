...
@Test func packageURLRequestParsesInstallIdentifiers() throws {
    ...
    let pkgxPkg = try #require(MainWindowPackageURLRequest(identifier: "pkgx:charm.sh/gum"))
    #expect(pkgxPkg.manager == .pkgx)
    #expect(pkgxPkg.name == "charm.sh/gum")
    #expect(pkgxPkg.identifier == "pkgx:charm.sh/gum")
    #expect(pkgxPkg.section == .pkgx)

    let pkgxURL = try #require(MainWindowPackageURLRequest(url: URL(string: "pkgmgrmgr://pkgx/charm.sh/gum")!))
    #expect(pkgxURL.manager == .pkgx)
    #expect(pkgxURL.name == "charm.sh/gum")
    #expect(pkgxURL.identifier == "pkgx:charm.sh/gum")
    #expect(pkgxURL.section == .pkgx)
...
@Test func languageSectionsGroupManagersAndSortPackagesAlphabetically() {
    ...
    #expect(MainWindowSection.managerSections.map(\.title) == ["Apps", "Go", "Homebrew", "JavaScript", "pkgx", "Python", "Rust", "Skills"])
    ...
    #expect(index.packagesBySection[.pkgx]?.map(\.displayName) == ["gum"])
...
@Test func packageRegistryLinksUseKnownPackageRegistryPages() {
    ...
    #expect(mainWindowRegistryURLString(for: ManagedPackage(manager: .pkgx, identifier: "pkgx:charm.sh/gum", installedVersion: nil, latestVersion: nil)) == "https://pkgx.dev/pkgs/charm.sh/gum/")
